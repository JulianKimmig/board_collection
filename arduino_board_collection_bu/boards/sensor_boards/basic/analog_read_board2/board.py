...
from arduino_board_collection.boards.sensor_boards.basic.analog_read_board.board import AnalogReadBoard
...
class AnalogReadBoard2(AnalogReadBoard):
    ...
    analog_value2 = arduio_variable(name="analog_value2", arduino_data_type=uint16_t,arduino_setter=False,is_data_point=True,save=False)
    analog_pin2 = arduio_variable(name="analog_pin2", arduino_data_type=uint8_t, eeprom=True)
